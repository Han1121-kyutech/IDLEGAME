...
// 名前、レベル、HP、攻撃、防御、XP
const Heros = [new HerosStatus("勇者", 1, 1000, 15, 0, 2)];

// 名前、レベル、HP、攻撃、防御、XP、レア度、お金
const Enemys = [
  new EnemysStatus("スライム", 1, 50, 5, 2, 1, 1, 1),
  new EnemysStatus("ゴブリン", 2, 80, 10, 10, 1.5, 2, 10),
  new EnemysStatus("ドラゴン", 3, 150, 20, 20, 25, 3, 50),
  new EnemysStatus("ゴールデンスライム", 4, 500, 50, 30, 20, 4, 200),
];
